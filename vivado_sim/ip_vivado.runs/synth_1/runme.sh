...
HD_PWD='D:/88-ISE_share/SIM/vivado_sim/ip_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log qspi_simulator_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source qspi_simulator_top.tcl
