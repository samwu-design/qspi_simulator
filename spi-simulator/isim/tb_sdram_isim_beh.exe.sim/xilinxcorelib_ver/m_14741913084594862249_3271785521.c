...
static void Cont_4613_24(char *t0)
{
    char t3[8];
    char t4[8];
    char t16[8];
...
static void Cont_4631_25(char *t0)
{
    char t3[8];
    char t4[8];
    char t6[8];
